...
$row = $res->fetch_assoc();
?>
<tr><td class="text-right">First Name:</td><td><input class="form-control" type='text' name='Fname' value='<?= $row['Fname']; ?>'></td></tr>
<tr><td class="text-right">Last Name:</td><td><input class="form-control" type='text' name='Lname' value='<?= $row['Lname']; ?>'></td></tr>
<tr><td class="text-right">Address:</td><td><textarea class="form-control" name='Address' ><?= $row['Address']; ?></textarea></td></tr>
<tr><td class="text-right">Phone:</td><td><input class="form-control" type='text' name='Phone' value='<?= $row['Phone']; ?>'></td></tr>
